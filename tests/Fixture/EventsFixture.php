...
class EventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'details' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null],
        ...
        'status' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => 'Scheduled', 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'active' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null],
        'unit_terlibat' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'urusetia' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'start' => '2020-07-08 07:24:06',
                'end' => '2020-07-08 07:24:06',
                'all_day' => 1,
                'status' => 'Lorem ipsum dolor ',
                'active' => 1,
                'unit_terlibat' => 'Lorem ipsum dolor sit amet',
                'urusetia' => 'Lorem ipsum dolor sit amet',
                'created' => '2020-07-08',
                'modified' => '2020-07-08',
            ],
        ];
